...
import {FacturasIndexPage} from './factura-index';
...
@Component({
	...
	templateUrl: './app/facturas/facturas.html',
        directives: [ROUTER_DIRECTIVES, FacturaFormComponent, FacturasIndexPage],
        viewProviders: [FacturaService, FacturaRESTClient],
})
@Routes([
  { path: '/', component: FacturasIndexPage },
  { path: '/new', component: FacturaFormComponent },
  { path: '/:id', component: FacturaShowComponent },
])
...
// 		HTTP_PROVIDERS
// 	],
// 	template: require('./facturas.html'),
