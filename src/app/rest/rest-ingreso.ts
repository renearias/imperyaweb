...
/**
 * Set default headers for every method of the RESTIngreso
...
function paramBuilder(paramName: string) {
    return function(key: string) {
        return function(target: RESTIngreso, propertyKey: string | symbol, parameterIndex: number) {
...
export function Headers(headersDef: any) {
    return function(target: RESTIngreso, propertyKey: string, descriptor: any) {
